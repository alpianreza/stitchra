...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('inward_inspections', function (Blueprint $table) {
            ...
            $table->timestamp('finalized_at', 6)->nullable();
        ...
        Schema::create('inward_inspection_lines', function (Blueprint $table) {
            ...
            $table->string('shade_verdict', 16)->nullable();
            $table->foreignId('defect_id')->nullable()->constrained('defect_library')->restrictOnDelete();
