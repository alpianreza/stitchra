...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // USD adalah default instalasi baru. Override hanya untuk test/legacy yang
        // memang masih memakai functional currency lain.
        $company = Company::firstOrCreate(
            ['id' => 1],
            [
                'code' => 'DEFAULT',
                'name' => 'Default Company',
                'base_currency' => env('STITCHRA_BASE_CURRENCY', 'USD'),
            ]
        );
        ...
        $prefixes = [
            'SO', 'PR', 'PO', 'RFQ', 'GR', 'FQC', 'MO', 'MI', 'CUT', 'TRF',
            'WIP', 'QC', 'NCR', 'PL', 'SHP', 'JW', 'OUT', 'ADJ', 'OPN', 'INV',
            'PAY', 'JE', 'SMPL', 'COST',
        ];
