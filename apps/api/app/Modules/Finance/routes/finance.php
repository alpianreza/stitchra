...
Route::middleware(['auth:sanctum','company'])->prefix('finance')->group(function(){
    ...
    Route::get('costing/mo/{productionOrder}/fg-actual',[CostingController::class,'d09Latest'])->middleware('permission:costing.actual.view');
    Route::post('costing/mo/{productionOrder}/fg-actual',[CostingController::class,'d09Calculate'])->middleware('permission:finance.journal.create');
    Route::get('costing/fg-actual/{costing}',[CostingController::class,'d09Detail'])->middleware('permission:costing.actual.view');
    Route::post('costing/fg-actual/{costing}/finalize',[CostingController::class,'d09Finalize'])->middleware('permission:finance.journal.approve');
