...
Route::middleware(['auth:sanctum','company'])->group(function(){
 ...
 Route::get('shopfloor/devices',[DeviceController::class,'index'])->middleware('permission:production.output.view');Route::post('shopfloor/devices',[DeviceController::class,'store'])->middleware('permission:production.output.create');Route::delete('shopfloor/devices/{device}',[DeviceController::class,'destroy'])->middleware('permission:production.output.create');
