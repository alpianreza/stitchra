...
class ProductionScan extends Model
{
    ...
    protected $fillable = ['company_id','bundle_id','operation_id','production_order_id','line_id','employee_id','direction','stage','scanned_at'];
    protected function casts(): array { return ['scanned_at' => 'datetime']; }

    protected static function booted(): void
    {
        static::updating(fn () => throw new LogicException('Production scan bersifat append-only.'));
        static::deleting(fn () => throw new LogicException('Production scan bersifat append-only.'));
    }
