...
Route::middleware(['auth:sanctum','company'])->group(function(){
    ...
    Route::get('shipping/shipments/{shipment}/valuation',[ShipmentController::class,'valuation'])->middleware('permission:shipping.shipment.view');
    Route::get('shipping/shipments/{shipment}/lines/{line}/valuation',[ShipmentController::class,'lineValuation'])->middleware('permission:shipping.shipment.view');
