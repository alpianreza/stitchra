...
class ProductionOrder extends Model
{
 ...
 public function salesOrder():BelongsTo{return$this->belongsTo(SalesOrder::class);}public function style():BelongsTo{return$this->belongsTo(Style::class);}public function bomVersion():BelongsTo{return$this->belongsTo(BomVersion::class);}public function routingVersion():BelongsTo{return$this->belongsTo(RoutingVersion::class);}public function standardCostSheet():BelongsTo{return$this->belongsTo(CostSheet::class,'standard_cost_sheet_id');}public function line():BelongsTo{return$this->belongsTo(Line::class);}public function matrixLines():HasMany{return$this->hasMany(MoLine::class);}public function materialAllocations():HasMany{return$this->hasMany(MoMaterialAllocation::class);}
}
